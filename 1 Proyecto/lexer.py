...
def getToken(imprime = True):
    ...
    while (c != '$'):
        ...
        if c not in simbolos2 and estado !=24 and estado!=26:
            ...
            return TokenType.ERROR, auxToken
        ...
        if c=='$':
            return TokenType.ENDFILE, token
        if estado == 2:  #token de numero
            auxToken = token
            token = ''
            estado = 0
            printea(TokenType.NUM,"\t \t",auxToken)
            return TokenType.NUM, auxToken
            ...
            if auxToken in reservedKeyWords:
                if auxToken == "else":
                    ...
                    return TokenType.ELSE, auxToken
                elif auxToken == "if":
                    printea(TokenType.IF,"\t \t",auxToken)
                    return TokenType.IF, auxToken
                elif auxToken == "int":
                    printea(TokenType.INT,"\t \t",auxToken)
                    return TokenType.INT, auxToken
                elif auxToken == "return":
                    printea(TokenType.RETURN,"\t \t",auxToken)
                    return TokenType.RETURN, auxToken
                elif auxToken == "void":
                    printea(TokenType.VOID,"\t \t",auxToken)
                    return TokenType.VOID, auxToken
                elif auxToken == "while":
                    printea(TokenType.WHILE,"\t \t",auxToken)
                    return TokenType.WHILE, auxToken
                else:
                    printea(TokenType.ERROR,"\t \t",auxToken)
                    return TokenType.ERROR, auxToken
            else:
                printea(TokenType.ID,"\t \t",auxToken)
                return TokenType.ID, auxToken
            ...
            return TokenType.OPENB, auxToken
            ...
            return TokenType.CLOSEB, auxToken
            ...
            return TokenType.OPENCURLYB, auxToken
            ...
            return TokenType.CLOSESQUAREB, auxToken
            ...
            return TokenType.CLOSECURLYB, auxToken
            ...
            return TokenType.PLUS, auxToken
            ...
            return TokenType.LESS, auxToken
            ...
            return TokenType.SEMICOL, auxToken
            ...
            return TokenType.COMMA, auxToken
            ...
            return TokenType.LTEQUAL, auxToken
            ...
            return TokenType.GTEQUAL, auxToken
            ...
            return TokenType.DIFF, auxToken
            ...
            return TokenType.COMMENT, auxToken
